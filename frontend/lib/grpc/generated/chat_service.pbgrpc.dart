...
class ChatServiceClient extends $grpc.Client {
  ...
  static final _$getRemainingSendCount = $grpc.ClientMethod<$0.ChatService_GetRemainingSendCountRequest, $0.ChatService_GetRemainingSendCountResponse>(
      '/ChatService/GetRemainingSendCount',
      ($0.ChatService_GetRemainingSendCountRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ChatService_GetRemainingSendCountResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ChatService_GetRemainingSendCountResponse> getRemainingSendCount($0.ChatService_GetRemainingSendCountRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getRemainingSendCount, request, options: options);
  }
}
...
abstract class ChatServiceBase extends $grpc.Service {
  ...
  ChatServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ChatService_GetRemainingSendCountRequest, $0.ChatService_GetRemainingSendCountResponse>(
        'GetRemainingSendCount',
        getRemainingSendCount_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ChatService_GetRemainingSendCountRequest.fromBuffer(value),
        ($0.ChatService_GetRemainingSendCountResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.ChatService_GetRemainingSendCountResponse> getRemainingSendCount_Pre($grpc.ServiceCall call, $async.Future<$0.ChatService_GetRemainingSendCountRequest> request) async {
    return getRemainingSendCount(call, await request);
  }
  ...
  $async.Future<$0.ChatService_GetRemainingSendCountResponse> getRemainingSendCount($grpc.ServiceCall call, $0.ChatService_GetRemainingSendCountRequest request);
}
