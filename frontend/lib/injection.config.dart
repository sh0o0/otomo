...
import 'package:otomo/controllers/auth.dart' as _i10;
import 'package:otomo/controllers/sign_in.dart' as _i9;
...
import 'package:otomo/injection.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.SignInController>(() => _i9.SignInController(
          gh<_i5.FirebaseAuth>(),
          gh<_i7.GoogleSignIn>(),
        ));
    gh.factory<_i10.AuthController>(
        () => _i10.AuthController(gh<_i5.FirebaseAuth>()));
    return this;
  }
}
