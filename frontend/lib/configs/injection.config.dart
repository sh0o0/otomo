...
import 'package:otomo/controllers/boundary/id_token.dart' as _i10;
...
import 'package:otomo/tools/global_state.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i6.FirebaseFirestore>(injectableModule.firebaseFirestore);
    gh.singleton<_i7.GlobalState>(injectableModule.globalState);
    gh.singleton<_i8.GoogleSignIn>(injectableModule.googleSignIn);
    gh.singleton<_i9.HealthServiceClient>(injectableModule.healthServiceClient);
    gh.singleton<_i10.IdTokenController>(injectableModule.idTokenController);
    gh.factory<_i11.LocationControllerImpl>(
        () => _i11.LocationControllerImpl());
    gh.factory<_i12.SignInControllerImpl>(() => _i12.SignInControllerImpl(
          gh<_i5.FirebaseAuth>(),
          gh<_i8.GoogleSignIn>(),
        ));
    gh.factory<_i13.AuthControllerImpl>(
        () => _i13.AuthControllerImpl(gh<_i5.FirebaseAuth>()));
    gh.factory<_i14.ChatControllerImpl>(
        () => _i14.ChatControllerImpl(gh<_i3.ChatServiceClient>()));
    return this;
  }
}
