...
var file_chat_service_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x8f, 0x02, 0x0a, 0x0b, 0x43, 0x68, 0x61,
...
var file_chat_service_proto_depIdxs = []int32{
	6, // 0: ChatService_SendMessageRequest.client_id:type_name -> google.protobuf.StringValue
	7, // 1: ChatService_SendMessageResponse.message:type_name -> Message
	7, // 2: ChatService_ListMessagesResponse.messages:type_name -> Message
	7, // 3: ChatService_AskToMessageResponse.message:type_name -> Message
	0, // 4: ChatService.SendMessage:input_type -> ChatService_SendMessageRequest
	2, // 5: ChatService.ListMessages:input_type -> ChatService_ListMessagesRequest
	4, // 6: ChatService.AskToMessage:input_type -> ChatService_AskToMessageRequest
	1, // 7: ChatService.SendMessage:output_type -> ChatService_SendMessageResponse
	3, // 8: ChatService.ListMessages:output_type -> ChatService_ListMessagesResponse
	5, // 9: ChatService.AskToMessage:output_type -> ChatService_AskToMessageResponse
